...
CREATE TABLE contenir (
    id_comm INTEGER NOT NULL REFERENCES commande(id_comm) ON DELETE CASCADE,
    id_article VARCHAR(20) NOT NULL REFERENCES article(id_article) ON DELETE CASCADE,
